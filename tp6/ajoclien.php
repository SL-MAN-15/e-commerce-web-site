...
<body style="padding:0px;
	...
	color: white;margin-top: 0px;">Ajouter un client</h1>
	</nav>
	...
	<form action="" method="post"><a href="ajou.php"><input type="button" value="return" ></a><br>
      ...
      <input type="text" name="nom" >
		<label for="textfield"> numero de telephone :</label>
...
if(isset($_POST["submit"])){
	...
	class clien{
		...
		public function __construct($m, $n,$nu){
			$this->mat=$m;
			$this->nom=$n;
