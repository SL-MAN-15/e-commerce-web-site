...
<body style="padding:0px;
	...
	color: white;margin-top: 0px;">supprimer un taxi</h1>
	</nav>
	
	<form action="" method="post">
		<a href="supp.php"><input type="button" value="return" ></a><br>
	  <label for="textfield"> matricule :</label>
      <input type="text" name="mat" id="textfield">
...
$id=new PDO($ch,$u,$pwd);
			...
			$b=$this->mat;
			$sql="DELETE FROM `taxi` WHERE `matricule`=$b";
